      ...
      overlay = final: prev: {
        photoprism = with final; (
          let
            ...
            libtensorflow-bin = prev.libtensorflow-bin.overrideAttrs (old: {
              ...
              src = fetchurl {
                url = "https://dl.photoprism.app/tensorflow/linux/libtensorflow-linux-avx2-1.15.2.tar.gz";
                ...
                frontend = let
                  noderanz = callPackage ranz2nix {
                    ...
                    packageOverride = name: spec:
                      if name == "minimist" && spec ? resolved && spec.resolved == "" && spec.version == "1.2.0"
                      then {
                        resolved =
                          "file://"
                          + (
